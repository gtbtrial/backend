...
mongoose.connect('mongodb+srv://gtbtrial:gtbtrial@cluster0.etrc8a7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0').then(() => console.log('Connected to MongoDB!'));;
